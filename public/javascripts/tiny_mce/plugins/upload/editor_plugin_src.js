	...
	tinymce.create('tinymce.plugins.UploadPlugin', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceUpload', function() {
				ed.windowManager.open({
					file : '/tiny_mce_images/new',
					width : 320 + parseInt(ed.getLang('upload.delta_width', 0)),
					height : 300 + parseInt(ed.getLang('upload.delta_height', 0)),
					inline : 1
				}, {
		...
		getInfo : function() {
			return {
				...
				author : 'Hard Hat Digital',
				authorurl : 'http://hardhatdigital.com.au',
				infourl : '',
				version : "1.0"
			};
		}
